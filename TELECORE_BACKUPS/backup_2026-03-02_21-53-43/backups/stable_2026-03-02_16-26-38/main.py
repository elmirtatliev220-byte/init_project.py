...
from app.core.models import Base, User, Channel, StatsHistory, PostStat, ScheduledPost, AdChannel, GroupProtection, TrafficSource, AutoResponse, AIRequest, WalletRequest, ChannelDeleteRequest, MovePostRequest, AutoDistributeRequest, ChatAnalytics
